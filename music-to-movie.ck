...
// "data/mannolove.wav"=> input.read;
// "data/diana.wav"=> input.read;
"data/drake.wav"=> input.read;
...
fun void synthesize( int uid )
{
    ...
    sendWindow( win.fileIndex, win.windowTime );
